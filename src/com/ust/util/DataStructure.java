...
public class DataStructure {
	...
	public DataStructure() {
        ...
        food.add(new FoodBean("F001", "Peporoni pizza", "15.00", "Medium", "Veg", 10,"S001"));
        food.add(new FoodBean("F002", "Charcol pizza", "10.00", "Small", "Non-Veg", 20,"S002"));
        food.add(new FoodBean("F003", "Pasta", "12.50", "Large", "Veg", 15,"S003"));
        food.add(new FoodBean("F004", "Chicken Wings", "18.00", "Medium", "Non-Veg", 5,"S004"));
        food.add(new FoodBean("F005", "Salad", "8.00", "Small", "Veg", 30,"S005"));
        food.add(new FoodBean("F001", "Peporoni pizza", "15.00", "Medium", "Veg", 10,"S005"));
        food.add(new FoodBean("F002", "Charcol pizza", "10.00", "Small", "Non-Veg", 20,"S004"));
        food.add(new FoodBean("F003", "Pasta", "12.50", "Large", "Veg", 15,"S002"));
        food.add(new FoodBean("F004", "Chicken Wings", "18.00", "Medium", "Non-Veg", 5,"S003"));
        food.add(new FoodBean("F005", "Salad", "8.00", "Small", "Veg", 30,"S001"));
     ...
     // Adding OrderBean objects
        ...
        orders.add(new OrderBean("O003", "U003", "2025-11-06", "S003", "out for delivery", "789 Pine St", "Chicago", "60001", "555-666-7777", 3, 50.00));
        orders.add(new OrderBean("O004", "U004", "2025-11-06", "S004", "Completed", "101 Maple St", "Houston", "77001", "222-333-4444", 4, 40.00));
        orders.add(new OrderBean("O005", "U005", "2025-11-07", "S005", "out for delivery", "202 Elm St", "Phoenix", "85001", "111-222-3333", 5, 30.00));
    }
